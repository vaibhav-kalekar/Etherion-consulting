...
{{< section-container class="py-20" >}}
    <div class="max-w-3xl mx-auto">
        <div class="grid gap-5 sm:grid-cols-2 mb-8">
            <div class="card">
                <p class="text-xs font-semibold uppercase tracking-eyebrow text-gray-400">Email Us</p>
                <p class="mt-3 text-base font-medium text-gray-900">info@etherionconsulting.com</p>
                <p class="mt-2 text-sm text-gray-500">We respond within 24 hours on business days.</p>
            </div>
            <div class="card">
                <p class="text-xs font-semibold uppercase tracking-eyebrow text-gray-400">Office Hours</p>
                <p class="mt-3 text-base font-medium text-gray-900">Mon–Fri, 9am–6pm AEST</p>
                <p class="mt-2 text-sm text-gray-500">Fast, private advisory for executive teams and program leaders.</p>
            </div>
        </div>
